...
function __wbg_adapter_20(arg0, arg1, arg2) {
    try {
        wasm.wasm_bindgen__convert__closures__invoke1_mut_ref__h9cd27dd235241e44(arg0, arg1, addBorrowedObject(arg2));
    } finally {
...
* @param {number} ptr
*/
__exports.wasm_thread_entry_point = function(ptr) {
...
/**
*/
__exports.Piece = Object.freeze({ J:1,"1":"J",L:2,"2":"L",S:3,"3":"S",Z:4,"4":"Z",T:5,"5":"T",I:6,"6":"I",O:7,"7":"O",Some:8,"8":"Some",None:0,"0":"None", });
/**
*/
__exports.Key = Object.freeze({ None:0,"0":"None",Left:1,"1":"Left",Right:2,"2":"Right",Cw:3,"3":"Cw",Ccw:4,"4":"Ccw",_180:5,"5":"_180",HardDrop:6,"6":"HardDrop",SoftDrop:7,"7":"SoftDrop",Hold:8,"8":"Hold", });
/**
*/
class Input {
    ...
    */
    set_board(x, y, p) {
        wasm.input_set_board(this.__wbg_ptr, x, y, p);
    }
    /**
    * @param {number} i
    * @param {number} p
    ...
    */
    test(p) {
        wasm.input_test(this.__wbg_ptr, p);
    }
}
...
class Prog {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Prog.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    static new(threads) {
        const ret = wasm.prog_new(threads);
        return Prog.__wrap(ret);
    }
    /**
    */
    test() {
        wasm.prog_test(this.__wbg_ptr);
    }
    /**
    */
    stop() {
        wasm.prog_stop(this.__wbg_ptr);
    }
    /**
    */
    start() {
        wasm.prog_start(this.__wbg_ptr);
    }
    /**
    */
    end() {
    ...
    */
    solution() {
        const ret = wasm.prog_solution(this.__wbg_ptr);
    ...
    */
    advance(input) {
        ...
        wasm.prog_advance(this.__wbg_ptr, ptr0);
    }
}
__exports.Prog = Prog;
